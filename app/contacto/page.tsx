          ...
          <div className="lg:col-span-5 flex flex-col gap-8">
            ...
            <div className="bg-secondary-container/30 p-8 border border-primary/10 rounded-2xl shadow-sm">
              ...
              <div className="mt-8 pt-8 border-t border-primary/20 flex gap-4">
                ...
                <a className="w-10 h-10 rounded-full border border-primary flex items-center justify-center text-primary hover:bg-primary hover:text-white transition-all shadow-sm hover:shadow-md" href="https://facebook.com/marcela.hilu" target="_blank" rel="noopener noreferrer">
