...
const services = [
  {
    title: "Masaje Descontracturante de Cuello y Espalda",
    shortDescription: "Alivia dolores y libera tensiones en cuello, hombros y espalda.",
    longDescription: (
      <>
  ...
  {
    title: "Masaje Descontracturante Corporal",
    shortDescription: "Reduce contracturas y devuelve bienestar a todo el cuerpo.",
    longDescription: (
      <>
  ...
  },
  {
    ...
    shortDescription: "Reduce la retención de líquidos y promueve ligereza corporal.",
    longDescription: (
      <>
  ...
  {
    title: "Drenaje Linfático de Miembros Inferiores",
    shortDescription: "Alivia la pesadez de las piernas y favorece una sensación de liviandad.",
    longDescription: (
      <>
  ...
  {
    title: "Relax & Drain",
    shortDescription: "Alivio muscular y ligereza corporal en una sola sesión.",
    longDescription: (
      <>
  ...
  },
  {
    ...
    shortDescription: "Estimula la circulación y ayuda a reducir la retención de líquidos.",
    longDescription: (
      <>
  ...
  {
    title: "Day Spa",
    shortDescription: "Una experiencia completa de relajación, cuidado y bienestar.",
    longDescription: (
      <>
