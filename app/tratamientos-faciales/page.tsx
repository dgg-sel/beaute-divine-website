...
const services = [
  {
    ...
    shortDescription: "Purifica, hidrata y devuelve luminosidad a la piel.",
    longDescription: (
      <>
  ...
  },
  {
    ...
    shortDescription: "Renueva y revitaliza la piel en minutos.",
    longDescription: (
      <>
  ...
  {
    title: "DETOX & LIFTING SHOCK",
    shortDescription: "Limpieza, luminosidad y efecto lifting inmediatos.",
    longDescription: (
      <>
  ...
  },
  {
    ...
    shortDescription: "Purifica, calma y ayuda a recuperar el equilibrio de la piel.",
    longDescription: (
      <>
  ...
  },
  {
    ...
    shortDescription: "Calma, fortalece y devuelve confort a la piel.",
    longDescription: (
      <>
  ...
  },
  {
    ...
    shortDescription: "Renueva la piel y potencia su luminosidad.",
    longDescription: (
      <>
