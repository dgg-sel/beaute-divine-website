...
const services = [
  {
    title: "SOUND HEALING MASSAGE",
    shortDescription: "Masaje y sonidos sagrados para armonizar cuerpo, mente y emociones.",
    longDescription: (
      <>
  ...
  {
    title: "SAINT-TOUCHÉ®",
    shortDescription: "Canalización energética a través de las manos para acompañar procesos de sanación integral.",
    longDescription: (
      <>
  ...
  },
  {
    ...
    shortDescription: "Una guía de autoconocimiento para comprender tu camino y tu presente.",
    longDescription: (
      <>
  ...
  {
    title: "TAMEANA",
    shortDescription: "Armonización vibracional con cristales para elevar tu frecuencia y acompañar procesos de transformación.",
    longDescription: (
      <>
  ...
  {
    title: "THETAHEALING®",
    shortDescription: "Transformación de creencias y patrones para impulsar cambios en tu vida.",
    longDescription: (
      <>
