...
export default function CheckoutPage() {
  ...
  // Costo de envío desde la variable de entorno pública
  // (se expone en runtime desde el servidor de checkout — aquí mostramos el valor a nivel UI)
  const SHIPPING_COST = parseFloat(
    process.env.NEXT_PUBLIC_SHIPPING_COST || "0"
  );
  ...
  return (
    <main className="pt-24 pb-16 min-h-screen bg-[#FDFBF7]">
      <div className="max-w-4xl mx-auto px-4 sm:px-8">
        ...
        <button
          onClick={() => router.back()}
          className="flex items-center gap-2 text-[#8C8377] hover:text-[#4A4238] transition-colors mb-10 text-sm font-medium"
        >
