...
## 3. Tecnologías
- El proyecto utiliza Next.js con React.
- Para los estilos y diseño usamos Tailwind CSS.

## 4. Tono y Comunicación
- El estilo de los textos de la web es elegante, holístico, cercano y centrado en el bienestar. Tratamos al usuario de "vos" (español rioplatense).
