...
export default function Footer() {
  return (
    <>
      ...
      <a className="fixed bottom-8 right-8 bg-[#25D366] text-white w-14 h-14 rounded-full flex items-center justify-center shadow-lg hover:scale-110 active:scale-95 transition-all z-[100]" href="https://wa.me/5491144133627" target="_blank" rel="noreferrer">
